...
BASE_PATH = here(normalizePath(file.path(getwd(), "..", "..")),"TEST_COMPASS") # Manual entry of BASE_PATH  # here() will send you to the root directory of your local drive
...
# write.csv(hmm_result$data, here::here("outputs", "HMM_2state_file.csv"), row.names = FALSE)
