...
def convert_edf_to_npy(
    edf_file_path: Union[str, Path], output_dir: Optional[Union[str, Path]] = None, overwrite: bool = False
) -> str:
    """
    ...
    try:
        ...
        with pyedflib.EdfReader(str(edf_file_path)) as edf_reader:
            ...
            edf_data = {"header": header, "signals": {}, "signal_headers": {}}  # Store individual signal metadata
